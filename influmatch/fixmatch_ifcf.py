"""FixMatch augmented with detached closed-form influence guidance."""
import torch

from semilearn.core.utils import ALGORITHMS
from semilearn.algorithms.fixmatch.fixmatch import FixMatch
from .closed_form_ifrank import ClosedFormIFRankMixin


@ALGORITHMS.register('fixmatch_influmatch')
class FixMatchInfluMatch(ClosedFormIFRankMixin, FixMatch):
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s):
        ...
        with self.amp_cm():
            ...
            # The influence branch is detached; the strong-view relation is live.
